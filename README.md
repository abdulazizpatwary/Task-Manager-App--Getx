...
|-------------|---------|---------|
| ![Splash](screenshots/splash.png) | ![Sign In](screenshots/signin.png) | ![Sign Up](screenshots/signup.png) |

| New Task Dashboard | Completed Task Dashboard | Canceled Task Dashboard |
|--------------------|--------------------------|--------------------------|
| ![NewTask](screenshots/newlistscreen.png) | ![Complete](screenshots/completetask.png) | ![Cancel](screenshots/canceledtask.png) |

| Progress Task Dashboard | Add Task | Update Profile |
|--------------------------|----------|----------------|
| ![Progress](screenshots/progresstask.png) | ![Add](screenshots/addtask.png) | ![Profile](screenshots/profileupdate.png) |
